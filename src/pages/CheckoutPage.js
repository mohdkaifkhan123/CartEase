...
export default function CheckoutPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 -my-3 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className=" lg:col-span-3 mt-3">
          <form className="bg-white px-5 py-12 mt-10 mb-8">
            <div className=" space-y-12">
              <div className=" border-b border-gray-900/10 pb-12">
                <h2 className="text-xl mt-9 flex  font-semibold leading-7 text-gray-900">
                    ...
                    >
                      <div className="flex min-w-0 gap-x-4">
                        ...
                        <div className="min-w-0 flex-auto">
                          <p className="flex text-sm font-semibold leading-6 text-gray-900">
                            {address.name}
                          </p>
                          <p className="flex mt-1 truncate text-xs leading-5 text-gray-500">
                            {address.street}
                          </p>
