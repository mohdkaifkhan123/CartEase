...
export default function ProductList() {
  ...
  const handeFilter=(e,section,option)=>{
            ...
            <div>
              ...
              <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 -my-3 gap-x-8 gap-y-10 lg:grid-cols-4">
                    {/* Filters */}
                                  ...
                                  {section.options.map((option, optionIdx) => (
                                    ...
                                    >
                                      <input
                                        ...
                                        type="checkbox"
                                        defaultChecked={option.checked}
                                        onChange={e=>handeFilter(e,section,option)}
                                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                      />
                                      <label
                              ...
                              <Link to="/productdetail">
                                ...
                                >
                                  ...
                                  <div className="mt-4 flex justify-between">
                                    <div>
                                      <h3 className="text-sm text-gray-700 flex-nowrap">
                                      ...
                                      <p className="flex mt-1 text-sm text-gray-500">
                                        <StarIcon className="h-5 w-6 inline"></StarIcon>
